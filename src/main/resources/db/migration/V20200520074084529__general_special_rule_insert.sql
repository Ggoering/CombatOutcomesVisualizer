...
(1, 7, 1, 'HEAVY_ARMOR', 2),
(1, 7, 1, 'PLATE_ARMOR', 3),
((SELECT id FROM public.limitation WHERE value = 'FIRST_ROUND_AND_CHARGING'), (SELECT id FROM public.modification WHERE value = 'STRENGTH'), (SELECT id FROM public.timing WHERE value = 'ALL'), 'DEVASTATING_CHARGE_STRENGTH_1', 1),
((SELECT id FROM public.limitation WHERE value = 'FIRST_ROUND_AND_CHARGING'), (SELECT id FROM public.modification WHERE value = 'ARMOR_PENETRATION'), (SELECT id FROM public.timing WHERE value = 'ALL'), 'DEVASTATING_CHARGE_ARMOR_PENETRATION_1', 1),
((SELECT id FROM public.limitation WHERE value = 'FIRST_ROUND_AND_CHARGING'), (SELECT id FROM public.modification WHERE value = 'STRENGTH'), (SELECT id FROM public.timing WHERE value = 'ALL'), 'DEVASTATING_CHARGE_STRENGTH_2', 2),
((SELECT id FROM public.limitation WHERE value = 'FIRST_ROUND_AND_CHARGING'), (SELECT id FROM public.modification WHERE value = 'ARMOR_PENETRATION'), (SELECT id FROM public.timing WHERE value = 'ALL'), 'DEVASTATING_CHARGE_ARMOR_PENETRATION_2', 2),
...
(10, 11),
(11, 12),
((SELECT id FROM public.special_rule WHERE name = 'LIGHT_LANCE'), (SELECT id FROM public.property WHERE name = 'DEVASTATING_CHARGE_STRENGTH_1')),
((SELECT id FROM public.special_rule WHERE name = 'LIGHT_LANCE'), (SELECT id FROM public.property WHERE name = 'DEVASTATING_CHARGE_ARMOR_PENETRATION_1')),
((SELECT id FROM public.special_rule WHERE name = 'LANCE'), (SELECT id FROM public.property WHERE name = 'DEVASTATING_CHARGE_STRENGTH_2')),
((SELECT id FROM public.special_rule WHERE name = 'LANCE'), (SELECT id FROM public.property WHERE name = 'DEVASTATING_CHARGE_ARMOR_PENETRATION_2')),
